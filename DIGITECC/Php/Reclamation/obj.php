...
$sub = "select * from objet_perdu order by date desc";
$result = mysqli_query($con,$sub);

while ($row = mysqli_fetch_assoc($result)) {
    echo "<li class='objets' style='color:black;'> <div style='font-style:italic;color:green;'>$row[Nom] $row[Prenom] :</div> <br> $row[Message]. <br><br> Mon numéro de téléphone est $row[num]. <br> Mon email est $row[email]. <br> Publie le $row[date]</li>";
}
?>
<!DOCTYPE html>
<html lang="en">
