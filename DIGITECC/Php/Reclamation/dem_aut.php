...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $query = "insert into demande (nom,prenom,email,objet,message,fonction) values ('$user_daa[nom]','$user_daa[prenom]','$user_daa[email]','$objet','$message','$fonction')";
...
<head>
    ...
    <link rel="stylesheet" href="../../Styles/Reclamation/dem.css">
...
<body>
	...
	<form method="post">
        ...
        <center>
            <div class="login">
                <br>
                <img class="logocent" src="../../Images/reclamation.png" >
                <br>
        <h1>Demande</h1>
