...
$sub = "select * from reclamation_newrest order by date desc";
$result = mysqli_query($con,$sub);
while ($row = mysqli_fetch_assoc($result)) {
    echo "<li class='objets' style='color:black;'> <div style='font-style:italic;color:green;'>$row[nom] $row[prenom] :</div> <br> $row[message] <br> publie le : $row[date] </li>";
}
