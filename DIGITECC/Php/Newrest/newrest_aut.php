...
$sub = "select * from menu order by date desc";
$result = mysqli_query($con,$sub);
while ($row = mysqli_fetch_assoc($result)) {
    echo "<li class='objets' style='color:black;'> <div style='font-style:italic;color:red;'>$row[nom] $row[prenom] :</div> <br> $row[message] <br> publie le : $row[date] </li>";
}
